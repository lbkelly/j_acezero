...
"""
The Genetic Algorithm used for the ECU stern agent for part of 1b.
...
class SternGA:
    def __init__(self):
        ...
        # how many cycles the chromosome will repeat the datA, we want only 12 cycle to happen because there is
        # 12 transitions
        self.CYCLES = 12
        ...
        self.converge_stagnant_fitness = 3000

        self.converge_tracker = 0
        self.converge_tracker_max = 3000
    ...
    def setup(self, seed):
        ...
        # as there are 12 transitions, we repeat this gene sequence 12 OR cycles times to get the required length
    ...
    def run_algorithm(self, seed):
        ...
        while i < self.GENERATIONS and not self.isConverged:
            ...
            for index, x in enumerate(self.population):
                ...
                chromosome_parameters.update_ecu_chromosome(x)
            ...
            output = str(i) + ',' + str(best_chromosome.fitness.values[0]) + ',' + str(average_fitness)
