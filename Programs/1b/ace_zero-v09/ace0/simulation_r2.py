...
class MultiAgentSimulation(object):
    ...
    def default_scenario():
        ...
        return {'name': 'default',
                ...
                'blue': {
                    'initial': find_data_file("blue.json"),
                    'agent_class': 'agents.fsm_agent.ecu_stern_conversion_output.EcuSternConversionAgent',
                    'agent_parameters': find_data_file("blue_tactics.json")},
                ...
                #
                #
                # 'red': {'initial': find_data_file("red.json"),
                #         'agent_class': 'agents.fsm_agent.ecu_stern_basic.EcuSternBasicAgent', #'agents.agent.Agent',
                #         'agent_parameters': find_data_file("red_tactics.json")}}
